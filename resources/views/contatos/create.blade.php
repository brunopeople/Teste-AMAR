...
@section('content')
    <form action="{{ route('contatos.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="telefone" class="form-control @error('telefone') is-invalid @enderror" id="telefoneInput" value="{{ old('telefone') }}">
            @error('telefone')
                <span class="invalid-feedback text-left" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="cep" class="form-control" id="cepInput" maxlength="9" value="{{ old('cep') }}">
        </div>

        <div class="mb-3">
            <label for="logradouroInput" class="form-label">Logradouro</label>
            <input type="text" name="logradouro" class="form-control" id="logradouroInput" value="{{ old('logradouro') }}">
        </div>

        <div class="mb-3">
            <label for="numeroInput" class="form-label">Número</label>
            <input type="text" name="numero" class="form-control" id="numeroInput" value="{{ old('numero') }}">
        </div>

        <div class="mb-3">
            <label for="bairroInput" class="form-label">Bairro</label>
            <input type="text" name="bairro" class="form-control" id="bairroInput" value="{{ old('bairro') }}">
        </div>

        <div class="mb-3">
            <label for="cidadeInput" class="form-label">cidade</label>
            <input type="text" name="cidade" class="form-control" id="cidadeInput" value="{{ old('cidade') }}">
        </div>

        <div class="mb-3">
            <label for="ufInput" class="form-label">UF</label>
            <input type="text" name="uf" class="form-control text-uppercase" maxlength="2" id="ufInput" value="{{ old('uf') }}">
        </div>
